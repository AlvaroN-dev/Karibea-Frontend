...
export function Hero({ onCategoryClick }: HeroProps) {
  ...
  return (
    <section className="relative w-full h-[360px] md:h-[520px] overflow-hidden">
      ...
      >
        {heroBanners.map((banner) => (
          ...
          >
            ...
            {/* CONTENT */}
            <div className="relative z-10 h-full max-w-7xl mx-auto px-5 md:px-6 flex items-center">
              <div className="max-w-xl text-white">
                ...
                <div className="flex gap-4">
                  ...
                  <button
                    ...
                    className="hidden md:inline-flex border border-white text-white px-8 py-4 text-lg hover:bg-white hover:text-black transition"
                  >
                    Ver ofertas
                  </button>
                </div>
      ...
      <button
        onClick={prevSlide}
        className="hidden md:flex absolute left-6 top-1/2 -translate-y-1/2 z-20 bg-black/40 hover:bg-black/60 p-3 rounded-full text-white transition"
      >
        <ChevronLeft size={28} />
      </button>
      ...
      <button
        onClick={nextSlide}
        className="hidden md:flex absolute right-6 top-1/2 -translate-y-1/2 z-20 bg-black/40 hover:bg-black/60 p-3 rounded-full text-white transition"
      >
